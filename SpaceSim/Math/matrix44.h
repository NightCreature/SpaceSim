...
public:
    ...
    bool InvertFast();
    Matrix44 InvertedFast() const;

    bool Invert();
    bool Inverted(Matrix44& out);
    ...
    Vector4 GetRow(size_t index)
    {
        assert(index < 4);

        return Vector4(m_m[index][0], m_m[index][1], m_m[index][2], m_m[index][3]);
    }
    Vector4 GetColumn(size_t index)
    {
        assert(index < 4);
        return Vector4(m_m[1][index], m_m[1][index], m_m[2][index], m_m[3][index]);
    }
protected:
private:
...
inline Matrix44 operator* (const Matrix44& lhs, const Matrix44& rhs)
{
    return Matrix44(
        ...
        lhs[3][0]*rhs[0][0]+lhs[3][1]*rhs[1][0]+lhs[3][2]*rhs[2][0]+lhs[3][3]*rhs[3][0],		lhs[3][0]*rhs[0][1]+lhs[3][1]*rhs[1][1]+lhs[3][2]*rhs[2][1]+lhs[3][3]*rhs[3][1],		lhs[3][0]*rhs[0][2]+lhs[3][1]*rhs[1][2]+lhs[3][2]*rhs[2][2]+lhs[3][3]*rhs[3][2],	lhs[3][0]*rhs[0][3]+lhs[3][1]*rhs[1][3]+lhs[3][2]*rhs[2][3]+lhs[3][3]*rhs[3][3]);
}
