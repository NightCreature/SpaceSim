...
#if !defined(USE_PROFILER) && (!defined(_FINALRELEASE))
...
struct EventTime
{
    ...
    BRO_INLINE void Start() { start = Profiler::GetHighPrecisionTime(); }
    BRO_INLINE void Stop() { finish = Profiler::GetHighPrecisionTime(); }
};
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define BROFILER_FRAME(FRAME_NAME)  static ::Profiler::ThreadScope mainThreadScope(FRAME_NAME);	\
									BRO_UNUSED(mainThreadScope);								\
									Profiler::NextFrame();										\
									BROFILER_EVENT("Frame")										\

#define BROFILER_THREAD(FRAME_NAME) ::Profiler::ThreadScope brofilerThreadScope(FRAME_NAME); \
									BRO_UNUSED(brofilerThreadScope);						 \

#define BROFILER_START_THREAD(FRAME_NAME) ::Profiler::RegisterThread(FRAME_NAME);

#define BROFILER_STOP_THREAD() ::Profiler::UnRegisterThread();
